...
{
    /// <inheritdoc />
    public partial class CriacaoInicialLimpa : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MetaValor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interesses_Projetos_ProjetoId",
                        column: x => x.ProjetoId,
                        principalTable: "Projetos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Interesses_Usuarios_InvestidorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interesses_InvestidorId",
                table: "Interesses",
                column: "InvestidorId");

            migrationBuilder.CreateIndex(
                name: "IX_Interesses_ProjetoId",
                table: "Interesses",
                column: "ProjetoId");
